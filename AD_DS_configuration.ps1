...
Install-ADDSForest -DomainName $DomainName -DomainNetbiosName $NetBios -ForestMode "Win2008R2" -DomainMode "Win2008R2" -InstallDNS:$false -SafeModeAdministratorPassword $SafeModePassword